...
# Can Chi and Nap Am
from .can_chi import THIEN_CAN, DIA_CHI, NGU_HANH, GIO_SINH_RANGE, NAP_AM
...
# Star Colors (Ngũ hành và Màu sắc)
from .star_colors import get_star_color, STAR_ELEMENTS, USER_COLOR_OVERRIDES