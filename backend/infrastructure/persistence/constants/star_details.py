...
CHINH_TINH_DETAILS = {
    ...
    'Thiên Lương': {
        ...
        'element': 'Thổ',
        'nature': 'Cát tinh',
        'rank': 'Phúc thọ tinh - Sao che chở',
        'meaning': {
            'general': 'Thiên Lương là sao phúc thọ, đại diện cho sự che chở và bảo bọc. Người có Thiên Lương thường nhân từ, hay giúp đỡ người khác.',
            'career': 'Thích hợp làm y tế, giáo dục, từ thiện, tư vấn. Có tâm phục vụ.',
            'relationship': 'Nhân hậu, được yêu quý. Hay lo lắng cho người khác.',
            'health': 'Sống thọ, khỏe mạnh. Tuổi già an nhàn.'
        },
        'brightness_effect': {
            'Miếu': 'Phúc thọ song toàn, được quý nhân phù hộ suốt đời',
            'Vượng': 'Có phúc, được nhiều người giúp đỡ',
            'Đắc': 'Có phúc nhưng phải tự cố gắng',
            'Bình': 'Phúc đức bình thường',
            'Hãm': 'Hay lo lắng thái quá, can thiệp việc người khác'
        },
        'keywords': ['phúc thọ', 'che chở', 'nhân từ', 'giúp đỡ', 'quý nhân']
    },
    'Thất Sát': {
        'type': 'Chính Tinh',
        'group': 'Thiên Phủ',
